...
US and other regions.
    ...
    illinois_minor_procedure = CodeSystemConcept(
        {
    ...
    hipaa_restrictions = CodeSystemConcept(
        {
    ...
    hipaa_research = CodeSystemConcept(
        {
            "code": "hipaa-research",
    ...
    hipaa_self_pay = CodeSystemConcept(
        {
            "code": "hipaa-self-pay",
    ...
    va_10_5345a_mhv = CodeSystemConcept(
        {
